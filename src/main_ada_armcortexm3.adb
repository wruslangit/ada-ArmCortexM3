...
-- ========================================================
procedure main_ada_armcortexm3 is
-- ========================================================
...
begin
   ...
   PADTS.dtstamp; ATIO.Put_Line ("Started main_ada_armcortexm3.adb program.");
   ATIO.New_Line;
   -- =====================================================
   ...
   -- =====================================================   
   ATIO.New_Line;
   PADTS.dtstamp; ATIO.Put_Line ("Ended main_ada_armcortexm3.adb program.");
   PADTS.dtstamp; ATIO.Put_Line ("Alhamdulillah 3 times WRY");

-- ========================================================
end main_ada_armcortexm3;
-- ========================================================
